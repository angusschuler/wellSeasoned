...
function chooseMeal(condition) {
    ...
    switch (condition) {
        ...
        case "Hot":
        case "Hail":
            var math = Math.floor(Math.random() * hot.length);
        ...
        case "Blowing Snow":
        case "Sleet":
            var math = Math.floor(Math.random() * cold.length) + 1;
            document.getElementById("recipe").innerHTML = cold[math];
            break;
        case "Rain":
        case "Showers":
        case "Drizzle":
            var math = Math.floor(Math.random() * rain.length);
            document.getElementById("recipe").innerHTML = rain[math];
            break;
        case "Mostly Cloudy":
        case "Partly Cloudy":
        case "Cloudy":
            var math = Math.floor(Math.random() * cloudy.length);
            document.getElementById("recipe").innerHTML = cloudy[math];
            break;
        case "Breezy":
        case "Windy":
            var math = Math.floor(Math.random() * windy.length);
            document.getElementById("recipe").innerHTML = windy[math];
            break;
        case "Mostly Clear":
        case "Fair":
        case "Clear":
            var math = Math.floor(Math.random() * clear.length);
